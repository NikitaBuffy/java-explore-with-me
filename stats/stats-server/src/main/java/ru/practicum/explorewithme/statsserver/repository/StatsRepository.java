...
public interface StatsRepository extends JpaRepository<Hit, Long> {
    ...
    @Query("SELECT new ru.practicum.explorewithme.statsserver.model.Stats(h.app, h.uri, COUNT(DISTINCT h.ip)) " +
            "FROM Hit h " +
    ...
    @Query("SELECT new ru.practicum.explorewithme.statsserver.model.Stats(h.app, h.uri, COUNT(h.uri)) " +
            "FROM Hit h " +
            "WHERE h.timestamp BETWEEN :start AND :end " +
